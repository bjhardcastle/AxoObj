...
%
%   trialstarts  -   (optional) [Nx1] array of trial start times, as Abf
%                               sample index
%
%   trialends    -   (optional) [Nx1] array of trial stop times, as Abf
%                               sample index
%
...
legend(ax,[line1 pt1 pt2],['Abf(:,' num2str(trialsettings.chan) ')'],['Trial starts (' num2str(length(trialstarts)) ')'],['Trial stops (' num2str(length(trialends)) ')'])
